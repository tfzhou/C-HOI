...
class HybridTaskCascadeRel(CascadeRCNN):
    ...
    def __init__(self,
                 ...
                 rel_neck=None,
                 **kwargs):
        super(HybridTaskCascadeRel, self).__init__(num_stages, backbone,
                                                   **kwargs)
    ...
    def _rel_forward_train_binary(self, x, gt_bboxes, gt_labels, gt_rel,
                                  gt_instid, debug_image=None,
                                  debug_filename=None):
        ...
        relations = assign_pairs(sbj_bboxes, sbj_labels, sbj_idxs,
